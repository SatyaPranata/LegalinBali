...
const PROPERTIES = [
  {
    emoji: '🏡', tag: 'Eco Certified', name: 'Villa Sentul Hijau',
    loc: 'Sentul, Bogor', beds: 4, baths: 3, area: 280,
    desc: 'Hunian mewah dengan taman tropis, panel surya 10 kWp, dan sistem pengolahan air mandiri.',
    price: 'Rp 3,2 M', color: 'from-green-500 to-green-700', type: 'Villa',
  },
  {
    emoji: '🌿', tag: 'Sustainable', name: 'Rumah Bogor Asri',
    loc: 'Bogor, Jawa Barat', beds: 3, baths: 2, area: 180,
    desc: 'Desain modern dengan konsep open living yang menyatu harmonis dengan alam sekitar.',
    price: 'Rp 1,8 M', color: 'from-green-400 to-green-600', type: 'Rumah',
  },
  {
    emoji: '🏘️', tag: 'Cluster Green', name: 'Cluster Depok Lestari',
    loc: 'Depok, Jawa Barat', beds: 3, baths: 2, area: 150,
    desc: 'Kompleks perumahan ramah lingkungan dengan fasilitas komunitas taman hijau seluas 2 ha.',
    price: 'Rp 1,2 M', color: 'from-green-300 to-green-500', type: 'Cluster',
  },
  {
    emoji: '🌾', tag: 'Prime Land', name: 'Kavling Cisarua Asri',
    loc: 'Cisarua, Bogor', beds: 0, baths: 0, area: 500,
    desc: 'Kavling tanah strategis di kawasan pegunungan dengan udara segar dan pemandangan hijau.',
    price: 'Rp 900 Jt', color: 'from-green-200 to-green-400', type: 'Kavling',
  },
  {
    emoji: '🏠', tag: 'Best Seller', name: 'Villa Puncak Elegan',
    loc: 'Puncak, Bogor', beds: 5, baths: 4, area: 350,
    desc: 'Villa premium di ketinggian 1.200 mdpl, lengkap dengan kolam renang air gunung alami.',
    price: 'Rp 5,5 M', color: 'from-green-600 to-green-800', type: 'Villa',
  },
  {
    emoji: '🌳', tag: 'Eco Living', name: 'Rumah Bambu Cibinong',
    loc: 'Cibinong, Bogor', beds: 3, baths: 2, area: 160,
    desc: 'Rumah unik berbahan bambu bersertifikasi dengan desain kontemporer dan efisiensi energi tinggi.',
    price: 'Rp 1,4 M', color: 'from-green-400 to-green-700', type: 'Rumah',
  },
]
...
function PropertyCard({ prop, delay }) {
  ...
  return (
    ...
    >
      <div className={`h-52 bg-gradient-to-br ${prop.color} flex items-center justify-center
                       text-7xl relative`}>
        {prop.emoji}
        <span className="absolute top-4 left-4 bg-green-600 text-white text-xs font-bold
                         uppercase tracking-wide px-3 py-1 rounded-full">{prop.tag}</span>
        <span className="absolute top-4 right-4 bg-white text-green-700 text-xs font-black
                         px-3 py-1 rounded-full shadow">{prop.price}</span>
      </div>
      <div className="p-6">
        ...
        <button className="w-full bg-green-100 text-green-700 font-semibold py-3 rounded-2xl
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          <Section>
            ...
            <h1 className="font-display text-4xl lg:text-6xl font-black text-white mb-4">
              Temukan Properti <em className="not-italic text-green-300">Impian</em> Anda
            </h1>
            <p className="text-white/75 text-lg max-w-xl mx-auto mb-8">
              Pilihan properti eco-friendly terbaik di area Jabodetabek dengan standar green building internasional.
            </p>
            {/* Search */}
      ...
      <section className="py-16 px-6 bg-cream">
        <Section className="max-w-3xl mx-auto text-center">
          ...
          <Link to="/kontak" className="btn-primary inline-block">🌿 Konsultasi Gratis</Link>
        </Section>
      </section>
    </>
  )
