...
const TEAM = [
  { init: "/img/boss.png", name: "Jiesta Sudibya", role: "Direktur", desc: "Arsitek bersertifikat LEED dengan 15 tahun pengalaman green building internasional.", emoji: "🌿" },
  { init: "/img/anggota-wanita.png", name: "Tjok Nia", role: "Staff Admin", desc: "Pakar lansekap tropis, lulusan ITB dengan portofolio 200+ taman eco-certified.", emoji: "🌺" },
  { init: "/img/anggota-pria.png", name: "Gus Dira", role: "Staff Legal", desc: "Insinyur sipil spesialis material ramah lingkungan dan konstruksi berkelanjutan.", emoji: "🏗️" },
  { init: "/img/anggota-pria.png", name: "Satya Pranata", role: "Staff Teknis", desc: "Ahli panel surya dan sistem energi terbarukan dengan 200+ instalasi sukses.", emoji: "⚡" },
];
    ...
    <Section className="flex justify-center mb-7">
      <div className="bg-white rounded-3xl p-7 card-hover border border-gray-100 shadow-sm text-center w-72">
        <img
          src={TEAM[0].init}
          alt={TEAM[0].name}
          className="w-20 h-20 rounded-full object-cover mx-auto mb-4 shadow-lg shadow-green-600/25"
        />
